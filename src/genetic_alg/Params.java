...
public class Params {
    static final String problemPath = "src\\train\\train_6.json";
    
//    static final int maxGenerations = 20000;
    static final int firstRoundGenerations = 10000;
    static final int GATournamentLayers = 3;
    ...
    static final double delayPunishmentFactor = 50;
    static final double overCapacityPunishmentFactor = 50;
    // Mutations
